    ...
    <div className="relative min-h-screen bg-[#030712] text-slate-300 font-mono selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <PageWrapper className="relative z-10 max-w-[1400px] md:px-16 pb-12">
        ...
        <header className="flex items-center justify-between border-b border-white/5 pb-8 mb-16 w-full">
          ...
          <div suppressHydrationWarning className="hidden md:block text-[10px] text-slate-500 tabular-nums tracking-[0.2em] uppercase">
      ...
      >
        {chunks}
                  ...
                  <p className="text-slate-400 border-l-2 border-white/10 pl-8 py-4 italic">
                   "As an aspiring Mechanical Engineer transitioning into AI and Data Science, I view technology as more than just pure utility; I view it as an Amanah (a trust). I find profound beauty in systems built without excess—where structural integrity directly mirrors ethical integrity. My ethos is rooted in Itqan (the pursuit of excellence): building intelligent, data-driven systems that are as beneficial, respectful, and precise as a perfectly machined gear."
                  </p>
                </div>
              </article>
            </section>
...
<aside className="xl:col-span-4 space-y-10">
  ...
  <div className="relative group">
    ...
    <div className="relative bg-[#050914] p-8 rounded-2xl border border-red-500/20 shadow-2xl">
      ...
      <h3 className="text-white font-bold mb-4 text-xl tracking-tight">
        {t('securitySubtitle')}
      </h3>
      <p className="text-sm leading-relaxed text-slate-500">
        "{t('securityBody')}"
      </p>
    </div> {/* <- These were likely the missing tags! */}
  </div>
